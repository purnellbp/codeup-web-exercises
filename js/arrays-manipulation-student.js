...
(function () {
    // So far we have talked about arrays as if they are static, and unchanging. This isn't the case. Today we'll be
    // talking about how we can change our arrays without just reassigning the values.

    /**
     * Audience: "But David, why would I need to know about that?"
     */

    // In the future, we maybe interacting with our data in a way where we won't be able to see it directly, so it's
    // important to keep these methods and functions in mind when we start to create bigger and bigger applications.
